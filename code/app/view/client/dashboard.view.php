...
<?php } $_SESSION['status'] = null; ?>
    ...
    <div class="all-rendred">
        ...
        <div class="rendred">
            ...
            <a class="line-icon" href="<?php echo URLROOT; ?>users/downloadfile/<?php echo $rendu->rendu_client; ?>"><img class="icon-download" src="<?php echo URLROOT ?>img/download.png"></a>
